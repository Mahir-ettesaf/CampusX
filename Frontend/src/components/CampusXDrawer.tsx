...
type NavigationRef = { navigate: (name: string, params?: object) => void; reset: (state: { index: number; routes: Array<{ name: string }> }) => void; getCurrentRoute?: () => { name?: string } | undefined };
...
export function CampusXDrawerProvider({ children, navigationRef }: { children: ReactNode; navigationRef: NavigationRef }) {
  ...
  useEffect(() => {
    if (!visible) return;
    void getStoredAuthSession().then((session) => setUser(session?.user || null));
...
const styles = StyleSheet.create({
  overlay: { flex: 1, flexDirection: "row", backgroundColor: "rgba(0, 8, 20, 0.56)" }, backdrop: { flex: 1 }, drawer: { width: "86%", maxWidth: 340, height: "100%", backgroundColor: colors.background, borderRightWidth: 1, borderRightColor: colors.border, elevation: 12, shadowColor: "#000", shadowOpacity: 0.45, shadowRadius: 18, shadowOffset: { width: 6, height: 0 } }, safeArea: { flex: 1 }, brandHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: spacing.lg, paddingVertical: spacing.md, borderBottomWidth: 1, borderBottomColor: colors.divider }, brandRow: { flexDirection: "row", alignItems: "center", gap: spacing.sm }, logo: { width: 38, height: 38, borderRadius: 12, justifyContent: "center", alignItems: "center", backgroundColor: colors.surfaceRaised, borderWidth: 1, borderColor: colors.primary }, logoText: { color: colors.primary, fontSize: 13, fontWeight: "800" }, brand: { color: colors.text, fontSize: 19, fontWeight: "800" }, brandCaption: { color: colors.textMuted, fontSize: 8, letterSpacing: 0.8, fontWeight: "800", marginTop: 1 }, profileCard: { flexDirection: "row", alignItems: "center", margin: spacing.lg, padding: spacing.md, borderRadius: radius.lg, backgroundColor: colors.surfaceRaised, borderWidth: 1, borderColor: colors.border }, avatar: { width: 46, height: 46, borderRadius: 23, justifyContent: "center", alignItems: "center", backgroundColor: colors.backgroundElevated, borderWidth: 1, borderColor: colors.primary }, avatarText: { color: colors.primary, fontSize: 16, fontWeight: "800" }, profileCopy: { flex: 1, marginLeft: spacing.md }, userName: { color: colors.text, fontSize: 16, fontWeight: "800" }, roleBadge: { alignSelf: "flex-start", borderRadius: radius.pill, backgroundColor: "#292750", paddingHorizontal: spacing.sm, paddingVertical: 3, marginTop: spacing.xs }, roleText: { color: colors.secondary, fontSize: 11, fontWeight: "800", textTransform: "capitalize" }, menuContent: { paddingHorizontal: spacing.md, paddingBottom: spacing.md }, section: { marginBottom: spacing.lg }, sectionTitle: { color: colors.textMuted, fontSize: 10, fontWeight: "800", letterSpacing: 1.2, marginLeft: spacing.sm, marginBottom: spacing.sm }, menuItem: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: spacing.md, borderRadius: radius.md, paddingHorizontal: spacing.md, marginBottom: 2 }, activeItem: { backgroundColor: colors.surfaceRaised, borderWidth: 1, borderColor: colors.border }, menuText: { color: colors.textMuted, fontSize: 15, fontWeight: "700", flex: 1 }, activeText: { color: colors.text }, activeDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.primary }, accountSection: { padding: spacing.md, borderTopWidth: 1, borderTopColor: colors.divider }, logoutButton: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: spacing.md, borderRadius: radius.md, paddingHorizontal: spacing.md, marginTop: spacing.sm, backgroundColor: "#2A1A28", borderWidth: 1, borderColor: "#5A2D38" }, logoutText: { color: colors.error, fontSize: 15, fontWeight: "800" }, menuButton: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center", backgroundColor: colors.surfaceRaised, borderWidth: 1, borderColor: colors.border },
});
